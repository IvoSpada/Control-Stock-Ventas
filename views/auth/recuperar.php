...
<div class='login-Admin'>
    ...
    <form method="POST" action="/recuperar?token=<?php echo htmlspecialchars($token); ?>">
        <div class="input-group">
            ...
            <input class="input-login" type="password" id="password" name="contraseña" placeholder="Tu Contraseña" >
        </div>   
        <div class="input-group">
            <label class="label-login" for="repContraseña">Repetir contraseña:</label>
            <input class="input-login" type="password" id="repContraseña" name="repContraseña" placeholder="Repita la contraseña" >
        </div>
